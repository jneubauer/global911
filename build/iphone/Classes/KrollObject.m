...
//@interface Global911Object : NSObject
//@end

@interface Global911Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Global911Object class]])
		{
			for (NSString *key in [[(Global911Object*)o modules] allKeys])
			{
