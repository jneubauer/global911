...
//@interface k02_030Object : NSObject
//@end

@interface k02_030Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k02_030Object class]])
		{
			for (NSString *key in [[(k02_030Object*)o modules] allKeys])
			{
