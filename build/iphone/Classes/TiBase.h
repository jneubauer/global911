...
// in simulator we redefine to format for k02_030 Developer console
...
{\
	NSString * exceptionName = [@"org.k02_030." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k02_030";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk02_030NativeItemNone = -1, 
	UIk02_030NativeItemSpinner = -2,
	UIk02_030NativeItemProgressBar = -3,
	
	UIk02_030NativeItemSlider = -4,
	UIk02_030NativeItemSwitch = -5,
	UIk02_030NativeItemMultiButton = -6,
	UIk02_030NativeItemSegmented = -7,
	
	UIk02_030NativeItemTextView = -8,
	UIk02_030NativeItemTextField = -9,
	UIk02_030NativeItemSearchBar = -10,
	
	UIk02_030NativeItemPicker = -11,
	UIk02_030NativeItemDatePicker = -12,
	
	UIk02_030NativeItemInfoLight = -13,
	UIk02_030NativeItemInfoDark = -14,
	
	UIk02_030NativeItemDisclosure = -15,
	
	UIk02_030NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k02_030 instances of
