...
// in simulator we redefine to format for Global911 Developer console
...
{\
	NSString * exceptionName = [@"org.global911." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.global911";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGlobal911NativeItemNone = -1, 
	UIGlobal911NativeItemSpinner = -2,
	UIGlobal911NativeItemProgressBar = -3,
	
	UIGlobal911NativeItemSlider = -4,
	UIGlobal911NativeItemSwitch = -5,
	UIGlobal911NativeItemMultiButton = -6,
	UIGlobal911NativeItemSegmented = -7,
	
	UIGlobal911NativeItemTextView = -8,
	UIGlobal911NativeItemTextField = -9,
	UIGlobal911NativeItemSearchBar = -10,
	
	UIGlobal911NativeItemPicker = -11,
	UIGlobal911NativeItemDatePicker = -12,
	
	UIGlobal911NativeItemInfoLight = -13,
	UIGlobal911NativeItemInfoDark = -14,
	
	UIGlobal911NativeItemDisclosure = -15,
	
	UIGlobal911NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Global911 instances of
