...
/**
 The base class for all Global911 modules
 */
...
/**
 Global911 Platform calls this method on startup.
 */
-(void)startup;

/**
 Global911 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Global911 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Global911 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Global911 Platform calls this method on resume.
 @param sender The sender of the event.
 */
