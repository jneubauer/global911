...
//Rare exceptions to indicate a bug in the _global911 code (Eg, method that a subclass should have implemented)
...
+ (id)createProxy:(NSString*)qualifiedName withProperties:(NSDictionary*)properties inContext:(id<TiEvaluator>)context
{
	...
	if (proxyClass == nil) {
		NSString *_global911 = [NSString stringWithFormat:@"%@%s",@"Ti","tanium."];
		if ([qualifiedName hasPrefix:_global911]) {
		...
		if (proxyClass==nil) {
			...
			@throw [NSException exceptionWithName:@"org.global911.module"
