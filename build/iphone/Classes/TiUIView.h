...
/**
 Base class for all Global911 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Global911 view hierarchy (such as wrapped iOS UIViews) was touched.
